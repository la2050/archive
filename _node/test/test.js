...
module.exports = {
  ...
  'The LEARN entries page has 18 projects': function (browser) {
    browser.url('http://localhost:4000/learn/')
    browser.waitForElementPresent('#project-list', 5000)
    browser.elements('css selector', '#project-list > li', function(res) {
      browser.assert.strictEqual(res.value.length, 18)
    })
  },

  'The CREATE entries page has 18 projects': function (browser) {
    browser.url('http://localhost:4000/create/')
    browser.waitForElementPresent('#project-list', 5000)
    browser.elements('css selector', '#project-list > li', function(res) {
      browser.assert.strictEqual(res.value.length, 18)
    })
  ...
  'The PLAY entries page has 9 projects': function (browser) {
    browser.url('http://localhost:4000/play/')
    browser.waitForElementPresent('#project-list', 5000)
    browser.elements('css selector', '#project-list > li', function(res) {
      browser.assert.strictEqual(res.value.length, 9)
    })
  },

  'The CONNECT entries page has 53 projects': function (browser) {
    browser.url('http://localhost:4000/connect/')
    browser.waitForElementPresent('#project-list', 5000)
    browser.elements('css selector', '#project-list > li', function(res) {
      browser.assert.strictEqual(res.value.length, 53)
    })
  },

  'The LIVE entries page has 42 projects': function (browser) {
    browser.url('http://localhost:4000/live/')
    browser.waitForElementPresent('#project-list', 5000)
    browser.elements('css selector', '#project-list > li', function(res) {
      browser.assert.strictEqual(res.value.length, 42)
    })
  },
