...
Please explain how you will evaluate your work.: >-
  ...
  and then uses those data to propel program improvements to increase impact. To
  evaluate our Los Angeles programs, PowerMyLearning administers surveys to
  ...
  also work with individual schools to collect and analyze achievement data that
  may be available locally, including results from the MAP assessment (a highly
  regarded interim assessment produced by NWEA). To protect student privacy, we
  use data collection protocols approved by an independent Institutional Review
  Board.
