...
maker_answers:
  ...
  Organization(s) twitter handle(s): www.twitter.com/adventplayhouse
  Organization(s) facebook handle(s): www.facebook.com/adventureplayhouse
  Organization(s) instagram handle(s): www.instagram.com/adventureplayhouse
  Please share the direct link for voters to sign up for your newsletter(s): www.adventureplayhouse.com
  EIN (for each organization): 38-3887199
  ...
  Please write a sample tweet to describe your submission.: >-
    Help us gather all the kids for a new place to learn and play together in a
  ...
  Where will you be working? Specifics: 'Adventure Playhouse 1116 San Fernando Rd. San Fernando, Ca 91340'
  ...
  How do you plan to use these resources to make change? Specifics: Build a homework / tutoring center with computers for kids to use for free.
  ...
  Please list at least one major barrier/challenge you anticipate. What is your strategy for overcoming these obstacles?: >-
    One challenge is getting the schools to come on board with the program
    without feeling obligated or feeling we are taking their funding away from
    them. To overcome this would be to create a plan for them to utilize our
    location for their students when there is a need and allow their staff to
    come in for teaching sessions if needed with all the IT resources available
    here. Another obstacle would be to show the community that this program is
    beneficial to their kids. Many people in this community are not used to
    change and could reject the idea. I would talk to the City Council members
    to implement a city wide plan for healthy kids with fun days and events that
    implement our location's services to allow the community to see what the
    program could do for their children as well as for them. The play area
    allows for adults to play with their children and keep them healthy as
    well. 
  Please explain how you will evaluate your work.: >-
    Evaluations will be based on attendance and community involvement. With the
    city wide events and people signing up for information and programs we will
  ...
  Are there other organizations doing similar work (whether complementary or competitive)? What is unique about your proposed approach?: >-
    There is a family center providing services for children in community for a
    fee depending on income, but there is no place that could combine the fun
    and health aspect together with the learning combined. We can use the reward
    of playtime when they finish their work and assignments. This also allows
  ...
  How do you plan to scale the success of your proposal?: >-
    ...
    that the proposal is working. We want this to be the main center that people
    can come to be safe and get out of the scorching heat or out of the rain and
    still have fun! We don't hold limits on fun, and if we can continue to grow
    in the community and provide free events for all families of all ages to be
...
maker_answers_list:
  ...
  - name: Organization(s) name(s)
    ...
    answer: Adventure Playhouse Indoor Activity Center
  ...
  - name: Organization(s) twitter handle(s)
    ...
    answer: www.twitter.com/adventplayhouse
  - name: Organization(s) facebook handle(s)
    ...
    answer: www.facebook.com/adventureplayhouse
  - name: Organization(s) instagram handle(s)
    ...
    answer: www.instagram.com/adventureplayhouse
  ...
  - name: 'In one to three sentences, please describe your proposal.'
    ...
    answer: >-
      We want to create a place that kids can play and learn all in the same
      environment. Parents can feel confident that their children will exercise
      and have fun while still keeping up with school work. Kids in a society
      that are stuck on technology can come and play and run around like kids
      used to.
  - name: Please write a sample tweet to describe your submission.
    label: ''
    explanation: ''
    answer: >-
      Help us gather all the kids for a new place to learn and play together in
  ...
  - name: Where will you be working? Specifics
    ...
    explanation: ''
    answer: 'Adventure Playhouse 1116 San Fernando Rd. San Fernando, Ca 91340'
  ...
  - name: >-
    ...
    answer: >-
      ...
      them. To overcome this would be to create a plan for them to utilize our
      location for their students when there is a need and allow their staff to
      come in for teaching sessions if needed with all the IT resources
      available here. Another obstacle would be to show the community that this
      program is beneficial to their kids. Many people in this community are not
      used to change and could reject the idea. I would talk to the City Council
      members to implement a city wide plan for healthy kids with fun days and
      events that implement our location's services to allow the community to
      see what the program could do for their children as well as for them. The
      play area allows for adults to play with their children and keep them
      healthy as well. 
  - name: Please explain how you will evaluate your work.
    label: ''
    explanation: ''
    answer: >-
      Evaluations will be based on attendance and community involvement. With
      the city wide events and people signing up for information and programs we
      will see where we can grow and where more funds can be allocated if
      needed.
  - name: >-
    ...
    explanation: ''
    answer: >-
      There is a family center providing services for children in community for
      a fee depending on income, but there is no place that could combine the
      fun and health aspect together with the learning combined. We can use the
      reward of playtime when they finish their work and assignments. This also
      allows for more time the parents can spend quality time with the children
  ...
  - name: >-
    ...
    label: ''
    explanation: ''
    answer: We do not have any partners at this time.
  - name: >-
    ...
    answer: >-
      With all the resources and construction, the costs will be close to the
      $100,000. If the project goes over we will be reaching out to local
      organizations to help sponsor more events to bring more people in.  We
      want to involve the community as much as possible to help create a safe
      place for all kids to come and play and learn. 
  - name: >-
      Please include a detailed budget of how you will use $100,000 to implement
      this project.
    label: ''
    explanation: ''
    answer: "Construction costs to create a learning center - $35,000\r\nComputers and internet - $25,000\r\nFurniture - $5,000\r\nMarketing and Campaigns - $10,000\r\nNon-Profit corporation status and legal fees - $2,500\r\nNew Play equipment for toddler classes - $7,500\r\nCommunity sponsored events to build awareness at schools -  $10,000 "
  - name: >-
  ...
  - name: How do you plan to scale the success of your proposal?
    ...
    answer: >-
      If we can increase the awareness of people and expand the reach to
      surrounding cities with class enrollment and visibility we would could see
      that the proposal is working. We want this to be the main center that
      people can come to be safe and get out of the scorching heat or out of the
      rain and still have fun! We don't hold limits on fun, and if we can
      continue to grow in the community and provide free events for all families
      of all ages to be in a community together that is what is the purpose. We
      want to keep expanding our programs and if we grow enough we would open
      other locations in the LA area to incorporate these programs and more. The
      sky is the limit!
