...
Please identify any partners or collaborators who will work with you on this project.: >-
  ...
  talks with companies such as TowelSafe (a cutting-edge company with a program
  that allows people to donate one pocketed towel with a toiletry kit to a local
  homeless individual) and KNOclothing (a socially-minded business that donates
  ...
  program. Through this program,customers can donate to a non-profit or charity
...
How will your project benefit Los Angeles?: >-
  ...
  double-digit percentage increases in the number of families, seniors and
  ...
  established chapter, with a fully self-sufficient and independent team that
