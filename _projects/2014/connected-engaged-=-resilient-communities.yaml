...
Explain how implementing your project within the next twelve months is an achievable goal.: >-
  ...
  ambassadors reach 102 communities throughout Los Angeles County with the goal
  of reaching all 272 in time. As a result, thousands of young people and adults
  have attended preparedness events and classes run or organized by Community
  Ambassadors and have also received or built preparedness kits. Community
  Ambassadors have also helped increase the number of Red Cross volunteers to a
  total of 8,000. Additionally, Community Ambassadors have worked with their
  elected officials to facilitate the signing of 32 preparedness proclamations.
  With this solid program framework in place along with our strong program
  partnerships, implementing our new preparedness strategy within the next year
  is achievable.
Please list at least two major barriers/challenges you anticipate. What is your strategy for ensuring a successful implementation?: "Challenge 1: The vast majority of LA residents understand conceptually that disasters happen all of the time and that the “Big One” is very likely to happen; and yet, there is a disconnect between this understanding and actually joining in the conversation and taking action to prepare. The neighbor-to-neighbor Map Your Neighborhood approach is effective because hearing preparedness information from a peer tends to resonate, and seeing a neighbor take preparedness action to protect his/her family tends to inspire others to also take action. \r\n\r\nChallenge 2: One of the most popular reasons people give as to why they do not volunteer is they do not have the time to commit. The Team Red Cross App removes this obstacle as users are asked to volunteer their time during times of emergency as they are able, and have the option to decline any volunteer jobs via their smart phone. The Team Red Cross App training is also a web-based, self-paced training as well. \r\n"
