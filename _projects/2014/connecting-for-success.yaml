...
Please elaborate on how your project will impact the above metrics.: >-
  ...
  their social isolation and maximizing their sense of connection to others will
  be more likely to care for their community and advocate for services to
  ...
  communities. Also, we will track the types of social actions they engage in to
  promote safety in their communities. Finally, 80 youth will be involved in the
  proposed project through the after school programs at the elementary school
  and high school levels. 
Please explain how you will evaluate your project.: "For the proposed project, LA’s BEST will track:\r\n\r\n1) The number of field staff and number of high school students trained to implement Connecting for Success.\r\n\r\n2) Change in levels of perceived social isolation among elementary school and high school students engaged in the project.\r\n\r\n3) Changes in levels of self-efficacy towards engaging in social action.\r\n"
What two lessons have informed your solution or project?: >-
  ...
  Goulston.  CFS provides LA’s BEST field staff with comprehensive training and
  tools to help upper grade elementary school students make healthy life
  decisions, especially when they are dealing with stress or other mental and
  emotional challenges, and to reduce tolerance for violence within their own
  neighborhoods, all while promoting global and civic consciousness.  The
  original curriculum uses the devastating problem of landmines and their impact
  on children in countries where they exist—particularly in Colombia—as an entry
  point and catalyst to encourage students to think and talk about similarities
  and differences between their lives in urban Los Angeles communities and the
  lives of their counterparts in Colombia.  For example, local gangs use guns,
  violence and intimidation to establish their territory in Los Angeles, while
  drug cartels in Colombia use landmines to secure their cocaine fields.  Both
